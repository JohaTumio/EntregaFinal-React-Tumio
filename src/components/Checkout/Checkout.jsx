                ...
                <div className="container contenedorFormulario mt-3">
                    ...
                    <div className="m-2 container-fluid">
                        <div className="row mb-2 align-items-center justify-content-center">
                            <label className="col-4 col-form-label text-center" htmlFor="nombre"><i class="fa-solid fa-user"></i> Nombre:</label>
                        ...
                        <div className="row mb-2 align-items-center justify-content-center">
                            <label className="col-4 col-form-label text-center" htmlFor="apellido"><i class="fa-solid fa-user"></i> Apellido:</label>
                            <div class="col-8 col-md-6">
                        ...
                        <div className="row mb-2 align-items-center justify-content-center">
                            <label className="col-4 col-form-label text-center" htmlFor="telefono"><i class="fa-solid fa-phone"></i> Teléfono:</label>
                            <div class="col-8 col-md-6">
                        ...
                        <div className="row mb-2 align-items-center justify-content-center">
                            <label className="col-4 col-form-label text-center" htmlFor="email"><i class="fa-regular fa-envelope"></i> Email:</label>
                            <div class="col-8 col-md-6">
                        ...
                        <div className="row mb-2 align-items-center justify-content-center">
                            <label className="col-4 col-form-label text-center" htmlFor="emailConfirmacion"><i class="fa-solid fa-check"></i> Confirmar email:</label>
                            <div class="col-8 col-md-6">
